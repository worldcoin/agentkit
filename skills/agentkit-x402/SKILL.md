...
Signed headers expire after five minutes and are single-use. Run `prove` again for every request — never reuse headers across requests or retries after a change.
