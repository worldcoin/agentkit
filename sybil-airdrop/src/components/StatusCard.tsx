	...
	return (
		<div className="rounded-xl border border-border bg-surface-raised p-5">
			<div className="mb-4">
				...
				<p className="text-xs text-text-secondary mt-0.5">Look up registration and claim status by address</p>
			</div>
	...
	return (
		<span
			className={`px-2 py-0.5 rounded text-xs font-medium ${
				active ? 'bg-success/10 text-success' : 'bg-surface-overlay text-text-muted border border-border'
			}`}
		>
