        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-text-secondary">
              <span className="text-text-primary font-medium">Register</span> your agent in the
              AgentBook with World ID.
            </p>
          </div>
          <div className="space-y-1.5">
            <p className="text-xs font-medium text-text-muted">Step 2</p>
            <p className="text-sm text-text-secondary">
              <span className="text-text-primary font-medium">Sign</span> a challenge to prove
              wallet ownership.
            </p>
          </div>
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-text-secondary">
              <span className="text-text-primary font-medium">Claim</span> tokens. The server
              verifies and sends them.
            </p>
          </div>
        </div>
      </div>
