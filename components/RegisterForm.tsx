...
import { createWalletClient, createPublicClient, custom, http, decodeAbiParameters } from 'viem'
...
export default function RegisterForm() {
  ...
  const agentBookAddress = process.env.NEXT_PUBLIC_AGENTBOOK_ADDRESS as
    | `0x${string}`
    | undefined
  ...
  const handleSuccess = async (result: IDKitResult) => {
    ...
    try {
      ...
      const v3Response = result.responses?.find((r): r is ResponseItemV3 => 'merkle_root' in r)
